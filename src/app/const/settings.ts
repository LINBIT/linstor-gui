...
export const GUI_KEY_VALUE_STORE_KEY = '__gui__settings';
export const GRAFANA_KEY_VALUE_STORE_KEY = '__grafana__ui__settings';
...
export const CONTROLLER_AUTH_REQUIRED_STORAGE_KEY = 'LINSTOR_CONTROLLER_AUTH_REQUIRED';
