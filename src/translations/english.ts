...
org_role = Viewer`,
    ...
    controller_auth_description:
      'Manage the LINSTOR controller Bearer token used by this browser session when controller token authentication is enabled.',
    controller_auth_storage_title: 'Browser-local token storage',
    controller_auth_storage_description:
      'This token is stored only in the current browser localStorage. It is not written to the LINSTOR cluster configuration.',
