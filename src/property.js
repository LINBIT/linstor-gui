const property = {
  properties: {
    ...
    storage_pool_exos_vlm_type: {
      ...
      info:
        "linear: Volumes are created from Disk Groups (vdisks), virtual: Volumes are created from Pools which is a set of Disk Groups (vdisks)"
    },
    storage_pool_exos_create_vlm_options: {
      key: ["NAMESPC_EXOS", "KEY_STOR_POOL_EXOS_CREATE_VOLUME_OPTIONS"],
      type: "string",
      info:
        "Any additional parameters appended to /create/volume/pool/${poolName}/size/${size}KiB/${vlmName}"
    },
    ...
    max_oversubscription_ratio: {
      ...
      max: 1000,
      info:
        "Maximum allowed ratio of the sum of volume sizes in a thin pool to the total capacity of the pool (default 20)"
    },
    proxy_memlimit: {
      unit_prefix: "1",
      min: 16777216,
    ...
    drbd_auto_quorum: {
      ...
      info:
        "Enables automatic setting of the 'quorum' and 'on-no-quorum' property",
      type: "symbol",
    ...
    drbd_auto_diskful: {
      ...
      info:
        "Makes a resource diskful if it was continuously diskless primary for X minutes",
      type: "long"
    },
    ...
    drbd_auto_verify_algo_disable: {
      ...
      info:
        "If set to true it will disable automatic setting of DRBD verify algorithm",
      type: "boolean_true_false"
    },
